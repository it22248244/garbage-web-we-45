...
import logo from "../../assets/logo/logo-landing.png";
...
export default function LandingPage() {
	...
	return (
		<div className="w-full overflow-x-auto">
			<div className="text-gunmetal w-full">
				...
				{/* Default Navbar */}
				<div className="hidden sm:flex fixed top-0 left-0 w-full px-16 py-4 shadow-md bg-neutral-0 bg-opacity-90 z-20">
					<div>
						<img src={logo} alt="logo" />
					</div>
					<div
				...
				{/* Hero Section */}
				<div
					className="flex flex-wrap justify-center content-center hero-background h-screen w-full text-center"
					id="home"
				>
					<div className="black-overlay absolute opacity-60 bg-neutral-900 w-full h-screen"></div>
				...
				>
					<div className="flex flex-col w-4/5 my-28 gap-6">
						...
						<div className=" text-xl text-[#555555]">
							Our Bin Tracker services revolutionize waste
							management through cutting-edge IoT technology and
							AI analysis. Say goodbye to overflowing bins and
						...
						<div className="flex flex-wrap lg:flex-nowrap justify-center md:justify-center lg:justify-between gap-10">
							<div className="flex flex-col gap-2 bg-neutral-0 shadow-lg rounded-xl w-full lg:w-1/3">
								...
								<div className="flex flex-col w-full gap-1 px-5 py-3 pb-7 rounded-xl">
									...
									<div className="font-medium">
										Our smart bins are equipped with
										advanced sensors that monitor fill
										levels in real-time. They reduce waste
										overflow, and save costs.
									</div>
								</div>
							</div>
							<div className="flex flex-col gap-2 bg-neutral-0 shadow-lg rounded-xl w-full lg:w-1/3">
							...
							<div className="flex flex-col gap-2 bg-neutral-0 shadow-lg rounded-xl w-full lg:w-1/3">
								...
								<div className="flex flex-col w-full gap-1 px-5 py-3 pb-7 rounded-xl">
									...
									<div className="font-medium">
										Track your bins on a real-time
										interactive map. Know exactly where your
										bins are located, their fill levels, and
										optimize collection routes effortlessly.
									</div>
								</div>
							</div>
						</div>
				...
				>
					<div className="flex flex-col w-4/5 my-28 gap-10">
						...
						<div className=" text-xl">
							...
							traditional waste management into a smart,
							data-driven solution. Our commitment to innovation
							and sustainability drives us forward.
						</div>
						<div className="flex gap-10">
							...
							<div className=" w-2/5 text-xl text-justify">
								Bin Tracker was born out of a desire to address
								the challenges of modern waste management.
								Traditional methods often lead to inefficient
								collection, increased operational costs, and
								environmental impact. With our IoT-based system,
								we've harnessed the power of technology to
								create a smarter, more sustainable way to manage
								waste.
							</div>
						</div>
						<div className="flex gap-10">
							...
							<div className=" w-2/5 text-xl text-justify">
								...
								boundaries of what's possible in waste
								management. Whether you're a municipality
								looking to optimize your collection routes or a
								business aiming to reduce its ecological
								footprint, Bin Tracker is your partner in
					...
					<div className="flex flex-wrap md:flex-nowrap w-4/5 my-28 gap-6">
						<div className="flex flex-col gap-3 w-full md:w-1/3">
							<div>
								...
								management smarter and more efficient. Through
								the integration of IoT technology and AI
								analysis, we're committed to helping communities
								and businesses reduce waste, cut costs, and
				...
				<div className="text-center py-3 w-full bg-primary-500 text-neutral-0">
					Bin Tracker - Revolutionizing Waste Management - SE-S1-WE-45 &copy; 2024. All rights reserved
				</div>
			</div>
		</div>
	);
