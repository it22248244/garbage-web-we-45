...
const Logo_collapse_png_1 = __importDefault(require("../../../assets/logo/Logo-collapse.png"));
...
function Sidebar(props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col fixed shadow-md bg-neutral-50 h-screen p-4 z-50 select-none" },
        ...
        react_1.default.createElement("div", { className: "w-full flex justify-center" }, collapse ? (react_1.default.createElement("img", { src: Logo_collapse_png_1.default, className: " w-2/3", alt: "logo" })) : (react_1.default.createElement("img", { src: Logo_full_png_1.default, className: "w-32", alt: "logo" }))),
        react_1.default.createElement("div", { className: `mt-8 ${collapse
                ? "flex flex-col flex-wrap justify-center content-center"
                : ""}` }, (_a = props.items) === null || _a === void 0 ? void 0 : _a.map((item, index) => {
