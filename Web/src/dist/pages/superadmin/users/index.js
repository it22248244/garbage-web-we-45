        ...
        react_1.default.createElement("div", { className: `flex flex-col w-full ${collapse ? "ml-20" : "ml-52"}` },
            ...
            react_1.default.createElement(modal_1.default, { showModal: createModalState.open, onRequestClose: () => setCreateModalState(Object.assign(Object.assign({}, createModalState), { open: !createModalState.open })) },
                ...
                react_1.default.createElement("div", { className: "flex flex-col flex-wrap justify-center content-center w-96" },
                    react_1.default.createElement("div", { className: "flex gap-5" },
                        react_1.default.createElement(index_2.default, { label: "First Name", placeholder: "first name", value: userData.first_name, onChange: (e) => {
                                setUserData(Object.assign(Object.assign({}, userData), { first_name: e.target.value }));
                            }, required: true }),
                        react_1.default.createElement(index_2.default, { label: "Last Name", placeholder: "last name", value: userData.last_name, onChange: (e) => {
                                setUserData(Object.assign(Object.assign({}, userData), { last_name: e.target.value }));
                            }, required: true })),
                    react_1.default.createElement("div", { className: "flex gap-5" },
                        react_1.default.createElement(index_2.default, { label: "Username", placeholder: "username", value: userData.username, onChange: (e) => {
                    ...
                    react_1.default.createElement(index_2.default, { label: "Email", type: "email", placeholder: "Email", value: userData.email, onChange: (e) => {
                            setUserData(Object.assign(Object.assign({}, userData), { email: e.target.value }));
                        } }),
                    createModalState.type === "create" ? (react_1.default.createElement(index_2.default, { label: "Password", type: "password", placeholder: "Password", value: userData.password, onChange: (e) => {
                            setUserData(Object.assign(Object.assign({}, userData), { password: e.target.value }));
                        }, required: true })) : (react_1.default.createElement(index_2.default, { label: "Password", type: "password", placeholder: "Password", value: userData.password, onChange: (e) => {
                            setUserData(Object.assign(Object.assign({}, userData), { password: e.target.value }));
                        } }))),
                react_1.default.createElement("div", { className: "flex w-full justify-center gap-10 mt-5" },
                    ...
                    createModalState.type === "edit" ? (react_1.default.createElement(index_1.default, { label: "Update", bgColor: "bg-primary-500", hoverColor: "hover:bg-primary-700", onClick: () => updateUser() })) : (react_1.default.createElement(index_1.default, { label: "Create", bgColor: "bg-primary-500", hoverColor: "hover:bg-primary-700", onClick: () => createUser() })))),
            react_1.default.createElement(modal_1.default, { showModal: deleteModalState.open, onRequestClose: () => setDeleteModalState(Object.assign(Object.assign({}, deleteModalState), { open: !deleteModalState.open })) },
                ...
                react_1.default.createElement("div", { className: "flex w-full justify-center gap-10 mt-5" },
                    ...
                    react_1.default.createElement(index_1.default, { label: "Delete", bgColor: "bg-red-400", hoverColor: "hover:bg-red-500", onClick: () => deleteUser(deleteModalState.id) }))),
            react_1.default.createElement("div", { className: "p-10 pb-2" },
                react_1.default.createElement("div", { className: "flex content-center justify-center py-2 px-5 gap-5 rounded-lg bg-primary-200" },
                    react_1.default.createElement("div", { className: "flex flex-wrap content-center w-1/2" },
                        react_1.default.createElement(index_2.default, { label: "Search", placeholder: "Search by name/username", onChange: (e) => filterObjects(e.target.value) })),
                    react_1.default.createElement("div", { className: "flex flex-wrap content-center w-1/2" },
