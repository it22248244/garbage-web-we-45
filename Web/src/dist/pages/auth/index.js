...
const Logo_full_png_1 = __importDefault(require("../../assets/logo/Logo-full.png"));
    ...
    return (react_1.default.createElement("div", { className: "flex flex-wrap flex-col justify-center content-center h-screen bg-neutral-50 font-poppins text-gunmetal" },
        react_1.default.createElement("div", { className: "bg-neutral-0 p-10 rounded-md flex flex-wrap lg:flex-nowrap mx-10 max-w-md lg:max-w-none gap-5 drop-shadow-2xl" },
            react_1.default.createElement("div", { className: "w-full max-w-sm flex flex-col flex-wrap gap-8" },
                react_1.default.createElement("img", { src: Logo_full_png_1.default, alt: "" }),
                react_1.default.createElement("h1", { className: " text-center text-4xl font-bold text-blue-600" }, "Login"),
                react_1.default.createElement("div", null,
                    react_1.default.createElement(index_1.default, { type: "text", label: "Email / Username", name: "identifier", icon: react_1.default.createElement(md_1.MdAlternateEmail, null), onChange: (e) => handleIdentifierChange(e.target.value) }),
                    react_1.default.createElement(index_1.default, { type: "password", label: "Password", name: "password", error: authInfo.login_error, icon: react_1.default.createElement(ri_1.RiLockPasswordFill, null), onChange: (e) => handlePasswordChange(e.target.value) }),
