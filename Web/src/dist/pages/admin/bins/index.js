    ...
    return (react_1.default.createElement("div", { className: "flex w-screen" },
        ...
        react_1.default.createElement(modal_1.default, { showModal: createModalState.open, onRequestClose: () => setCreateModalState(Object.assign(Object.assign({}, createModalState), { open: !createModalState.open })) },
            ...
            react_1.default.createElement("div", { className: "flex flex-col flex-wrap justify-center content-center gap-3 w-fit" },
                react_1.default.createElement("div", { className: "flex gap-5" },
                    react_1.default.createElement(index_2.default, { label: "Name", placeholder: "name", value: binData.name, onChange: (e) => {
            ...
            react_1.default.createElement("div", { className: "flex w-full justify-center gap-10 mt-5" },
                ...
                createModalState.type === "edit" ? (react_1.default.createElement(index_1.default, { label: "Update", bgColor: "bg-primary-500", hoverColor: "hover:bg-primary-700", onClick: () => updateBin() })) : (react_1.default.createElement(index_1.default, { label: "Create", bgColor: "bg-primary-500", hoverColor: "hover:bg-primary-700", onClick: () => createBin() })))),
        react_1.default.createElement(modal_1.default, { showModal: deleteModalState.open, onRequestClose: () => setDeleteModalState(Object.assign(Object.assign({}, deleteModalState), { open: !deleteModalState.open })) },
            ...
            react_1.default.createElement("div", { className: "flex w-full justify-center gap-10 mt-5" },
                ...
                react_1.default.createElement(index_1.default, { label: "Delete", bgColor: "bg-red-400", hoverColor: "hover:bg-red-500", onClick: () => deleteBins(deleteModalState.id) }))),
            ...
            react_1.default.createElement("div", { className: "p-10 pb-2" },
                react_1.default.createElement("div", { className: "flex content-center justify-center py-2 px-5 gap-5 rounded-lg bg-primary-200" },
                    react_1.default.createElement("div", { className: "flex flex-wrap content-center w-1/2" },
                        react_1.default.createElement(index_2.default, { label: "Search", placeholder: "Search by id/name", onChange: (e) => filterObjects(e.target.value) })),
                    react_1.default.createElement("div", { className: "flex flex-wrap content-center w-1/2" },
