            ...
            react_1.default.createElement(modal_1.default, { showModal: createModalState, onRequestClose: () => setCreateModalState(!createModalState) },
                ...
                react_1.default.createElement("div", { className: "flex flex-col flex-wrap justify-center content-center gap-3 w-fit" },
                    react_1.default.createElement("div", null,
                        ...
                        react_1.default.createElement(index_1.default, { label: "Select Image", onClick: () => imageInput.current
                ...
                react_1.default.createElement("div", { className: "flex w-full justify-center gap-10 mt-5" },
                    react_1.default.createElement(index_1.default, { label: "Cancel", color: "text-gunmetal", bgColor: "bg-neutral-100", hoverColor: "hover:bg-neutral-600", onClick: () => setCreateModalState(false) }),
                    react_1.default.createElement(index_1.default, { label: "Update", bgColor: "bg-primary-500", hoverColor: "hover:bg-primary-700", onClick: () => { updateImage(); setCreateModalState(false); } }))),
                ...
                react_1.default.createElement("div", { className: "flex flex-col w-4/5 gap-6" },
                    ...
                    react_1.default.createElement("div", { className: "flex justify-end content-center mt-8" },
                        react_1.default.createElement("div", { className: "flex content-center flex-wrap h-10 rounded-md font-semibold\n                                text-neutral-0", onClick: () => updateProfile() },
                            react_1.default.createElement(index_1.default, { label: "Save", disabled: disabledInputs.button }))))))));
}
